  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <Card>
          <Accordion type="multiple" defaultValue={['financial-status', 'retirement-plans', 'financial-decision']} className="w-full">
            <AccordionItem value="financial-status">
              <AccordionTrigger className="px-6 py-4 font-headline text-lg">Current Financial Status</AccordionTrigger>
            ...
            <AccordionItem value="retirement-plans">
              <AccordionTrigger className="px-6 py-4 font-headline text-lg">Retirement Plans</AccordionTrigger>
              <AccordionContent className="px-6">
                <div className="grid grid-cols-1 gap-4 pt-2 md:grid-cols-2">
            ...
            <AccordionItem value="financial-decision" className="border-b-0">
              <AccordionTrigger className="px-6 py-4 font-headline text-lg">New Financial Decision</AccordionTrigger>
              <AccordionContent className="px-6">
